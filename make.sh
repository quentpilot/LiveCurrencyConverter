...
# @Last modified time:  2017-11-04T14:50:21+01:00
# @License:             MIT
# @See:                 projects.quentinlebian.fr/LiveCurrencyConverter


#!/bin/bash
javac -cp '.:resources/lib/gson-2.8.0.jar:resources/lib/json-20140107.jar:resources/lib/httpcore-4.4.7.jar:resources/lib/httpclient-4.5.3.jar:resources/lib/commons-logging-1.2.jar' src/Parser/*.java src/Reader/*.java src/Computer/*.java src/Converter/*.java src/Core/*.java
